<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="opraviServis.aspx.cs" Inherits="ServiseranjeVozil.opraviServis" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Opravi servis</title>
    <meta charset="UTF-8" />
...
<p style="text-align:center" id="peter" runat="server">Tukaj lahko označite določen servis za opravljen oziroma zaključen</p>
