<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="brisiPoslovalnice.aspx.cs" Inherits="ServiseranjeVozil.brisiPoslovalnice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Briši poslovalnice</title>
    <meta charset="UTF-8" />
...
<p style="text-align:center" id="peter" runat="server">Tukaj lahko brišete poslovalnice</p>
    <form id="form1" runat="server">
    <div>
    
        <asp:Label ID="Label1" runat="server" Text="Izberi poslovalnico"></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server" style="margin-left: 50px">
        </asp:DropDownList>
    
        <br />
        <asp:Button ID="Button1" runat="server" Text="Brisi poslovalnico" OnClick="Button1_Click" />
