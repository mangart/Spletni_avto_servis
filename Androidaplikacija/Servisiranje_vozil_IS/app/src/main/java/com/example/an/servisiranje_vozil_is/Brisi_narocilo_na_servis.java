...
public class Brisi_narocilo_na_servis extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brisi_narocilo_na_servis);
        ...
        hsv1 = (ScrollView) findViewById( R.id.scrollView4 );
        layout = (LinearLayout) hsv1.findViewById( R.id.hsvLayout4 );
        layout.removeAllViews();
        dobi_neodobrene_servise();
    }

    public void iz_bris_naroc_na_meni(android.view.View v){
    ...
    public void dobi_neodobrene_servise(){
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Get_neodobrena_narocila/" + sekundarni_id;
    ...
    public void izbrisi_narocilo(int idn){
