...
public class Potrdi_narocilo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_potrdi_narocilo);
        ...
        hsv1 = (ScrollView) findViewById( R.id.scrollView5 );
        layout = (LinearLayout) hsv1.findViewById( R.id.hsvLayout5 );
        layout.removeAllViews();
        dobi_narocila_poslovalnice();


    }

    public  void iz_potrd_na_men(android.view.View v){
    ...
    public void dobi_narocila_poslovalnice(){
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Get_neodobrena_narocila_poslovalnice/" + id_poslovalnice;
                                ...
                                try {
                                    ...
                                    myButton.setOnClickListener(new View.OnClickListener() {
                                        public void onClick(View v) {
                                            potrdi_narocilo(v.getId());
                                        }
                                    });
                                    myButton.setTextColor( Color.YELLOW );
                                    myButton.setGravity( Gravity.CENTER_VERTICAL | Gravity.CENTER_HORIZONTAL );
                                    myButton.setText( jsonObj.get("ime").toString() + " " + jsonObj.get("priimek") + ", " +jsonObj.get("znamka").toString() + " " + jsonObj.get("model").toString() + ", " + jsonObj.get("naziv") + ", " + jsonObj.get("kraj") + ", " +
    ...
    public void potrdi_narocilo(int idn){
        String id = String.valueOf(idn);
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Odobri_narocila/" + id;
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(response.equals("Vse je vredu!")) {
                        ...
                        CharSequence text = "Naročilo je bilo uspešno potrjeno!";
