...
public class Opravi_narocilo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opravi_narocilo);
        ...
        hsv1 = (ScrollView) findViewById( R.id.scrollView7 );
        layout = (LinearLayout) hsv1.findViewById( R.id.hsvLayout7 );
        layout.removeAllViews();
        dobi_opravljena_narocila();
    }

    public void iz_opr_nar_na_men(android.view.View v){
    ...
    public void dobi_opravljena_narocila(){
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Get_odobrena_narocila_poslovalnice/" + id_poslovalnice;
    ...
    public void opravi_narocilo(int idn){
        String id = String.valueOf(idn);
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Opravi_narocila/" + id;
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(response.equals("Vse je vredu!")) {
                        ...
                        CharSequence text = "Naročilo je bilo uspešno opravljeno!";
