...
public class Brisi_narocilo_poslovalnice extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brisi_narocilo_poslovalnice);
        ...
        hsv1 = (ScrollView) findViewById( R.id.scrollView6 );
        layout = (LinearLayout) hsv1.findViewById( R.id.hsvLayout6 );
        layout.removeAllViews();
        dobi_narocila();
    }

    public void iz_bris_posl_nar_na_men(android.view.View v){
    ...
    public void brisi_narocilo(int idn){
        String id = String.valueOf(idn);
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Izbrisi_narocilo/" + id;
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(response.equals("Vse je vredu!")) {
                        ...
                        CharSequence text = "Naročilo je bilo uspešno izbrisano!";
