...
public class Pregled_odobrenih_servisov extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pregled_odobrenih_servisov);
        ...
        hsv1 = (ScrollView) findViewById( R.id.scrollView2 );
        layout = (LinearLayout) hsv1.findViewById( R.id.hsvLayout2 );
        layout.removeAllViews();
        dobi_odobrene_servise();
    }

    public void iz_preg_odob_na_meni(android.view.View v){
    ...
    public void dobi_odobrene_servise(){
        String url = "http://serviseranjevozil20180809013812.azurewebsites.net/Service1.svc/Get_odobrena_narocila/" + sekundarni_id;
